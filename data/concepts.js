...
const conceptsData = [
  ...
  },
  {
    ...
    oneLiner: "不用买服务器，按需付费，随用随开，全球部署",
    duration: 10,
    lectureId: 2
  },
  {
    ...
    oneLiner: "Region是城市（如北京），AZ是城市里的不同数据中心，Edge是靠近用户的加速点",
    duration: 10,
    lectureId: 3
  },
  {
  ...
  },
  {
    ...
    oneLiner: "AWS给你一套建云系统的最佳实践清单，涵盖6大方面",
    duration: 12,
    lectureId: 5
  },
  {
    ...
    oneLiner: "帮助公司平稳迁移到云的指南，不只关注技术，更关注人和流程",
    duration: 10,
    lectureId: 6
  },
  {
    ...
    oneLiner: "IaaS你管系统和软件，PaaS你只管代码，SaaS拿来即用",
    duration: 8,
    lectureId: 7
  },
  {
    ...
    oneLiner: "算成本要算全：硬件+电费+机房+运维+人力，云按秒付费",
    duration: 10,
    lectureId: 8
  },
  {
    ...
    oneLiner: "托管=AWS帮你管系统升级和维护，你只管业务",
    duration: 8,
    lectureId: 9
  },
  {
    ...
    oneLiner: "IAM就是AWS的门禁系统，决定谁能进、能做什么",
    duration: 12,
    lectureId: 10
  },
  {
    ...
    oneLiner: "Identity-based管人，Resource-based管资源，SCP管组织边界",
    duration: 10,
    lectureId: 11
  },
  {
    ...
    oneLiner: "密码+动态验证码，双重保险，像银行卡+手机验证",
    duration: 8,
    lectureId: 12
  },
  {
    ...
    oneLiner: "KMS是AWS的保险箱，帮你管理加密密钥，数据加密后乱码无法破解",
    duration: 12,
    lectureId: 13
  },
  {
    ...
    oneLiner: "SG是服务器门口的保镖（记住熟人），NACL是小区大门保安（每人都查）",
    duration: 10,
    lectureId: 14
  },
  {
    ...
    oneLiner: "WAF防火防黑客攻击，Shield防DDoS流量攻击",
    duration: 10,
    lectureId: 15
  },
  {
    ...
    oneLiner: "Trail是摄像头录像谁干了什么，Watch是报警器系统异常了就响",
    duration: 10,
    lectureId: 16
  },
  {
    ...
    oneLiner: "AWS的合规文件柜，下载各种认证报告和协议",
    duration: 8,
    lectureId: 17
  },
  {
    ...
    oneLiner: "Secrets Manager专门管密码且自动轮换，Parameter Store存配置项也能存密码",
    duration: 10,
    lectureId: 18
  },
  {
    ...
    oneLiner: "GuardDuty抓坏人威胁，Inspector检查应用漏洞，Config检查配置合不合规",
    duration: 12,
    lectureId: 19
  },
  {
    ...
    oneLiner: "一个账号登录多个AWS账号，不用记多套密码",
    duration: 10,
    lectureId: 20
  }
  // 注意: 这里只包含前20个概念作为示例
